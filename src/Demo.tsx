...
function urlForResult(
  ...
  const prefixUrl = `${publicResultFolder}/${dataset}`;
    ...
    <div className="App">
      ...
      <Container maxWidth="lg">
        ...
        <Typography variant="h6" align="left" paragraph>
          ...
          datasets, content image ID (from 1 to 25), and style image ID (from 1
          to 10).
        </Typography>
        ...
        <Typography align="left" variant="body1" color="inherit" gutterBottom>
          [1]{' '}
          <Link
            href="https://arxiv.org/abs/1804.04732"
            target="_blank"
            rel="noopener"
          >
            {`Xun Huang, Ming-Yu Liu, Serge Belongie, Jan Kautz, "Multimodal
          ...
          <Link
            ...
            rel="noopener"
          >
            {`Wonwoong Cho, Sungha Choi, David Keetae Park, Inkyu Shin, Jaegul
